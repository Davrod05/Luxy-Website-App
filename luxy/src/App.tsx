  ...
  return (
    ...
    >
      <div className="min-h-screen bg-black/95 flex flex-col items-center justify-start">
        ...
        <section className="bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(/media/mapbg.jpeg)] bg-no-repeat bg-center bg-cover w-full text-center pb-10">
        ...
        <section>
          <div className="w-full py-10">
            <img
              src="\media\2026-suburban-ck10906-3lz-g6m-trimselector.avif"
              alt="car_img"
              className="h-40"
            />
          </div>
